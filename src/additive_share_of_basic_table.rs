...
// fn process_row (row: &rusqlite::Row) -> (i64, i64, i64, i64, i64, i64,i64,i64,i64) {
     fn process_row (id:i64,order_key:i64, part_key:i64, line_number:i64, supp_key:i64) -> (i64,i64, i64, i64, i64, i64, i64,i64 ,i64) {
...
return(id,order_key1, order_key2 ,part_key1 ,part_key2 ,line_number1 ,line_number2 ,supp_key1 ,supp_key2 );
     }
...
pub fn share(value:i64)->(i64,i64){
    ...
    let query = "SELECT  id, order_key, part_key, line_number, supp_key from line_item_1m";
     let mut stmt = conn.query_map(query,|(id, order_key, part_key, line_number, supp_key)| { LineItem { id, order_key, part_key, line_number, supp_key} });
   
     for row in stmt.iter().flatten() {

        let ( id,order_key1, order_key2 ,part_key1 ,part_key2 ,line_number1 ,line_number2 ,supp_key1 ,supp_key2
        )=process_row(row.id,row.order_key,row.part_key,row.line_number,row.supp_key);
